              ...
              unsigned seqno_them)
{
    ...
    case STATE_READY_TO_SEND<<8 | TCP_WHAT_TIMEOUT:
        ...
        if (banner1->tcp_payloads[tcb->port_them]) {
            ...
            x = (unsigned char*)banner1->tcp_payloads[tcb->port_them]->hello;
    ...
    case STATE_WAITING_FOR_RESPONSE<<8 | TCP_WHAT_DATA:
        {
            ...
            if (more.length) {
                ...
                tcpcon_send_packet(tcpcon, tcb, 0x18, (const unsigned char*)more.payload, more.length, 0);

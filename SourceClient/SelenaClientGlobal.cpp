...
//-----------------------------------------------------------------------------
		...
		#define THREAD_LIB		"pthreadD.lib         "
		...
		#define LIBERRKEEP_LIB	"ÑommonErrkeeperS.lib  "
	...
	#pragma message("		Connectin ... " THREAD_LIB)
	#pragma comment (lib, THREAD_LIB)
	...
	#pragma message("		    Now we can use the program masskan API,")
	#pragma message("		    whose program code was linked as a static library.")
	#pragma message("		    Static library with API masskan also compiles well on the Linux platform.")

	#pragma message("		Connectin ... " NMAP_LIB)
	#pragma comment (lib, NMAP_LIB)
	#pragma message("		    Now we can use the program nmap API,")
	#pragma message("		    whose program code was linked as a static library.")

	#pragma message("		Connection all Nmap dependences.")
...
//-----------------------------------------------------------------------------
// Global variables for interconnection between threads

// Signal to terminate all threads & client program
ThrSfBool			stopSignal;
// Stack of message for client from server
ThrSfSelenaMessages	clientMsg;
// Stack of control commands for client from server
ThrSfSelenaMessages	clientCom;
// Information about current job that performing right now
ThrSfSelenaJob		clientJob;
// HDD-Storage of jobs resived from server
ThrSfSelenaJobsMng	clientJobsStorage;
